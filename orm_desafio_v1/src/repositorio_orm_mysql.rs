...
pub struct RepositorioOrmMySql<T: TEntidade> {
    pool: Pool,
    _marker: PhantomData<T>,
}

impl<T: TEntidade> RepositorioOrmMySql<T> {
    ...
    pub fn apagar_tabela(&self) {
        ...
        conn.exec_drop(T::generate_sql_drop_table(), {}).expect("Failed to create table.");
    }
